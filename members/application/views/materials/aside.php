<section class="main_container">
	<aside class = "sidebar">
		...
		<ul>
			<a href="<?php echo base_url();?>materials/display"><li class="aside_button">&#x25B8; All (<?php echo $count_all;?>)</li></a>
			<li class="aside_button" onclick = "initializeModal()" >&#x25B8; Create Raw Materials</li>
			<!-- <li class="aside_button" id="trigger_deactivate">&#x25B8; Deactivate Raw Materials</li> -->
	...
	function initializeModal(){
		$.ajax({
			type: 'POST',
			url: '<?php echo site_url("materials/add");?>',
			success: function(msg){
				$('#osx_view_title').html("Add Raw Materials");
